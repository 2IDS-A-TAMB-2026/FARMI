                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                                '${crop.type}  •  ${crop.area?.toStringAsFixed(0) ?? "--"} ha  •  ${crop.season ?? "--"}',
                                style: GoogleFonts.inter(
                            ...
                            Row(
                              children: [
                                _buildChip(
                                    _statusLabels[crop.status] ?? crop.status,
                                    _statusColor(crop.status)),
                                const SizedBox(width: 6),
                                _buildChip(
                                    _healthLabels[crop.health] ?? crop.health,
                                    _healthColor(crop.health)),
                              ],
                            ),
                          ],
                        ),
