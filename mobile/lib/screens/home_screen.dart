...
class _HomeScreenState extends State<HomeScreen> {
  ...
  final GlobalKey sobreKey = GlobalKey();
  final GlobalKey identidadeKey = GlobalKey();
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      TextButton(
                        onPressed: () => _scrollTo(identidadeKey),
                        child: const Text(
                          'Nos contrate',
                          style: TextStyle(color: Colors.white),
                        ),
  ...
  Widget _text() {
    return Text(
      'A FARMI (Fazenda Automatizada e Remota com Monitoramento Inteligente) é uma solução de AgTech focada em transformar a gestão rural por meio da tecnologia. Nosso objetivo é centralizar dados dispersos em uma plataforma única, facilitando a tomada de decisão e aumentando a produtividade no campo. Através de sensores IoT, monitoramos em tempo real indicadores como temperatura, umidade e luminosidade do tempo. O sistema oferece um painel intuitivo com alertas automáticos sobre condições críticas, garantindo o uso sustentável de recursos e redução de custos. Projetada para pequenos e grandes produtores, a FARMI une a tradição do cultivo à inovação digital.',
      style: GoogleFonts.inter(
        fontSize: 14,
