...
class _AlertsScreenState extends State<AlertsScreen> {
  List<AlertModel> _alerts = [
    AlertModel(
      ...
      message: 'Sensor Temp. Estufa registrou 34°C',
      type: 'extreme_temperature',
      severity: 'high',
      sensorName: 'Sensor Temp. Estufa',
      isRead: false,
    ),
    AlertModel(
      id: '2',
      title: 'Umidade do solo muito baixa',
      message: 'Sensor Umid. Solo B2 registrou 22%',
      type: 'low_humidity',
      severity: 'critical',
      sensorName: 'Sensor Umid. Solo B2',
      isRead: false,
    ),
    AlertModel(
      id: '3',
      title: 'Sensor em manutenção',
      message: 'Sensor Temp. Estufa em modo de manutenção',
      type: 'sensor_failure',
      severity: 'medium',
      sensorName: 'Sensor Temp. Estufa',
      isRead: false,
    ...
    AlertModel(
      id: '4',
      title: 'Baixa luminosidade detectada',
      message: 'Luminosidade abaixo do esperado',
      type: 'low_light',
      severity: 'low',
      sensorName: 'Sensor Luz',
      isRead: true,
    ),
    AlertModel(
      id: '5',
      title: 'Sensor desativado',
      message: 'Sensor Umid. Solo B2 foi desativado',
      type: 'sensor_failure',
      severity: 'high',
      sensorName: 'Sensor Umid. Solo B2',
      isRead: true,
