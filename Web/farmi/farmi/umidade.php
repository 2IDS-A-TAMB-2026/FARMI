...
<body>
    ...
    <aside class="sidebar">
        ...
        <nav>
           <a href="dashboard.php" class="menu-item"><i class="fa-solid fa-chart-line"></i> Dashboard</a>
            ...
            <a href="umidade.php" class="menu-item active"><i class="fa-solid fa-droplet"></i> Umidade</a>
    ...
    <main class="main-content">
        ...
        <header class="header">
            <div>
                <h2>Monitoramento de Umidade (DHT22)</h2>
        ...
        <?php
            ...
            // Determinar status baseado na umidade
            if ($sensor_data['umidade'] < 40) {
                $sensor_data['status'] = 'low';
            } elseif ($sensor_data['umidade'] > 70) {
        ...
        <div class="sensor-visualization">
            ...
            <div class="humidity-meter">
                <span class="hum-value"><?php echo $sensor_data['umidade']; ?>%</span>
        ...
        <div class="stats-grid">
            <div class="card">
                <div class="card-info">
                    <h3>Umidade Atual</h3>
                    <p><?php echo $sensor_data['umidade']; ?>%</p>
                </div>
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        ...
                        <td><?php echo $sensor_data['umidade']; ?>%</td>
