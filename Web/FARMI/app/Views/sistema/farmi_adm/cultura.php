        ...
        <div class="form-section">
            ...
            <form action="<?= base_url('/cultura/inserir') ?>" method="POST" id="formCultura" class="form-grid">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="nome" name="NOME_CULTURA" required placeholder="Ex: Milho Safrinha">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="ciclo" name="CICLO_PRODUTIVO" min="30" max="365" required placeholder="120">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="area" name="AREA_CULTIVADA" min="0.01" max="1000000" step="0.01" required placeholder="25.50">
                </div>
                <div class="form-group">
                    <label for="sensorLuz">
                    ...
                    <input type="text" id="lux" name="SENSOR_LUZ" required placeholder="Ex: 50000 lux">
                </div>
                <div class="form-group">
                    <label for="sensorTemp">
                        <i class="fa-solid fa-cloud"></i>
                        Sensor de clima (Temp.°C):
                    </label>
                    <input type="text" id="temperatura" name="SENSOR_CLIMA_TEMPO" required placeholder="Ex: 24°C">
                </div>
                <div class="form-group">
                    <label for="sensorUmi">
                    ...
                    <input type="text" id="umidade_ar" name="SENSOR_CLIMA_UMIDADE" required placeholder="Ex: 65%">
                </div>
                <div class="form-group">
                    ...
                    <input type="text" id="umidade_solo" name="SENSOR_SOLO" placeholder="Ex: 70%">
                </div>
                <div class="form-group">
                    <label for="STATUS">
                        <i class="fa-solid fa-seedling"></i>
...
function detalhesSensores(fazenda, luz, temperatura, umidade, solo)
{
    let html = `
        <div style="display:flex; flex-direction:column; gap:12px; margin-top:15px;">
            <div style="background:#e8f5e9; padding:12px; border-radius:10px; text-align:left; margin-bottom:12px;">
                <i class="fa-solid fa-tractor" style="color:#2e7d32;"></i>
                <strong> Fazenda:</strong> ${fazenda}
            </div>
            <div style="background:#f5f5f5; padding:12px; border-radius:10px; text-align:left;">
                <i class="fa-solid fa-lightbulb" style="color:#fbc02d;"></i>
                <strong> Sensor de Luz:</strong> ${luz} lux
            </div>
            <div style="background:#f5f5f5; padding:12px; border-radius:10px; text-align:left;">
                <i class="fa-solid fa-temperature-half" style="color:#ef5350;"></i>
                <strong> Sensor de Temperatura:</strong> ${temperatura}°C
            </div>
            <div style="background:#f5f5f5; padding:12px; border-radius:10px; text-align:left;">
                <i class="fa-solid fa-cloud-rain" style="color:#42a5f5;"></i>
                <strong> Sensor de Umidade:</strong> ${umidade}%
            </div>
            <div style="background:#f5f5f5; padding:12px; border-radius:10px; text-align:left;">
                <i class="fa-solid fa-seedling" style="color:#66bb6a;"></i>
                <strong> Sensor do Solo:</strong> ${solo}%
            </div>
        </div>
    `;
    Swal.fire({
