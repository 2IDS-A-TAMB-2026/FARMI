...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* --- MEDIDOR DE SOLO (corrigido para não estourar com o zoom de fonte) --- */
        .soil-meter {
            width: 200px;
            height: 200px;
            min-width: 200px;
    ...
    <main class="main-content">
        ...
        <header class="header">
            ...
            <div class="header-right">
                ...
                <button id="aumentar-fonte" class="accessibility-btn" type="button">
    A+
                </button>

                <button id="diminuir-fonte" class="accessibility-btn" type="button">
                    A-
                </button>

                <button id="resetar-fonte" class="accessibility-btn" type="button">
                    A
                </button>
        ...
        <div class="sensor-visualization">
            ...
            <div class="soil-meter">
                <span class="soil-value"><?= number_format($solo, 1, ',', '.') ?>%</span>
                <span class="soil-unit">Umidade do Solo</span>
                <span class="status status-<?= $status ?>">
                    <i class="fa-solid fa-check"></i> 
                    <?php 
                        if($status == 'optimal') echo 'Ideal';
                        elseif($status == 'dry') echo 'Seco';
                        else echo 'Úmido';
                    ?>
                </span>
            </div>
   ...
   <script>
    ...
    if (aumentarFonte) {
        aumentarFonte.addEventListener('click', () => {
            // Limite máximo reduzido de 150 para 120, e passo reduzido de 10 para 5
            if (tamanhoFonte < 120) {
                tamanhoFonte += 5;
                aplicarFonte();
            }
    ...
    if (diminuirFonte) {
        diminuirFonte.addEventListener('click', () => {
            // Limite mínimo elevado de 70 para 85, e passo reduzido de 10 para 5
            if (tamanhoFonte > 85) {
                tamanhoFonte -= 5;
                aplicarFonte();
            }
