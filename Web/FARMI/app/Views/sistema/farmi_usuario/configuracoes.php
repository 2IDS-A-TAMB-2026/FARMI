...
*/
body.alto-contraste button:not(.fonte-btn):not(.logout-btn),
body.alto-contraste .btn:not(.fonte-btn):not(.logout-btn) {
...
<body>
   ...
   <div class="header-right">
    ...
    <button id="aumentar-fonte" class="fonte-btn">A+</button>

    <button id="diminuir-fonte" class="fonte-btn">A-</button>

    <button id="fonte-normal" class="fonte-btn">A</button>
...
const fonteNormal = document.getElementById('fonte-normal');
