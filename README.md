...
*Sprint 4*
- Integração IoT - 100%
- Código C++ conecta com a ESP32 - 100%
- Documentação dos cassos de testes - 100%
- Roteiro de apresentação final - 100%
...
*Sprint 4*
- Consumo de RESTfull web servisse (GET) no mobile - 100%
- Desenvolvimento da API Back-End com CodeIgniter- 100%
